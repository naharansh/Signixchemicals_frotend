          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="grid grid-cols-3 gap-4 flex-1">
              ...
              <div className="rounded-lg border bg-gray-50 p-4 text-center relative">
                ...
                <img src={second} alt="" srcset="" className="h-5 w-4 absolute -top-0 right-7" />
                   <img src={second} alt="" srcset="" className="h-5 w-4 absolute -top-0 right-2" />
              </div>

              <div className="rounded-lg border bg-purple-100 border-purple-400 p-4 text-center relative">
                <h4 className="text-xl font-semibold">1</h4>
                <p className="text-sm text-gray-600">Urgent</p>
                   <img src={second} alt="" srcset="" className="h-5 w-3 absolute -top-0 right-7" />
                   <img src={second} alt="" srcset="" className="h-5 w-3 absolute -top-0 right-2" />
                      <img src={second} alt="" srcset="" className="h-5 w-3 absolute -top-0 right-12" />
